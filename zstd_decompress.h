...
uint32_t dictionary_get_id(dictionary_t *const dict);
uint8_t* dictionary_get_symbols(dictionary_t *const dict);
uint8_t* dictionary_get_num_bits(dictionary_t *const dict);
uint16_t* dictionary_get_base(dictionary_t *const dict);
